  ...
  var methods = {
    init: function(settings) {
      return this.each(function() {
        ...
        methods._bindFinishButton.call(self);
        ...
        if (key == 13) {
          ...
          if (buttons.length) {
            ...
            if (next.length) {
              ...
              self.finishButton.trigger('click');
            }
          }
        }
      });
    ...
    _bindFinishButton: function() {
      ...
      this.finishButton = self.find('.stepy-finish');
    ...
    _createBackButton: function(nav, index) {
      var
        self       = this,
        that       = $(this),
        attributes = { href: 'javascript:void(0);', 'class': 'stepy-back', html: self.opt.backLabel };
    ...
    _createNextButton: function(nav, index) {
      var
        self       = this,
        that       = $(this),
        attributes = { href: 'javascript:void(0);', 'class': 'stepy-next', html: self.opt.nextLabel };
...
debugger;
      ...
      if (methods._isLastStep.call(this, index, steps)) {
        that.find('.stepy-finish').show();
      } else {
        that.find('.stepy-finish').hide();
      }
